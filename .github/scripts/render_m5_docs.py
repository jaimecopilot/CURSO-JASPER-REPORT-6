...
def main():
    ...
    reports={}
    for kind,src,name in [("teoria",args.theory,"TEORIA_M5"),("practica",args.practice,"PRACTICA_M5")]:
    ...
    (out/"PRECHECK_M5.json").write_text(json.dumps(reports,ensure_ascii=False,indent=2),encoding="utf-8")
