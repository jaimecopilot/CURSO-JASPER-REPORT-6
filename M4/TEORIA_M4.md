...
En los parámetros del informe el mecanismo declarativo de respaldo es `defaultValueExpression`. Si se necesita un valor derivado de otros parámetros, se expresa directamente en el elemento que lo consume o se calcula desde Java. `initialValueExpression` se estudiará con las variables, donde sí forma parte del ciclo de inicialización.
