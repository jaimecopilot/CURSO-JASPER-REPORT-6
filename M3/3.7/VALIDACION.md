...
**Punto:** Introducción a Parameters y Variables  
...
Comprobaciones específicas: parámetros `usuario` y `fechaInforme`, variables `TotalUnidades` y `TotalImporte`, `PARAMETROS_VARIABLES.md`, 14 títulos, 31 unidades, 633,40 € y PDF de ventas de una página. Los cinco PDF acumulativos fueron inspeccionados visualmente.
