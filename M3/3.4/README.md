...
- Esta carpeta contiene la solución acumulativa de referencia al finalizar el punto 3.4.
...
Generadores acumulativos: GeneradorInformeConcepto, GeneradorCatalogoCSV, GeneradorDistribucionXML, GeneradorAutoresJSON.
