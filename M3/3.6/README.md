...
- Esta carpeta contiene la solución acumulativa de referencia al finalizar el punto 3.6.
...
java -cp "target/classes;<classpath>" GeneradorDistribucionXML
java -cp "target/classes;<classpath>" GeneradorAutoresJSON
java -cp "target/classes;<classpath>" GeneradorInformeVentas
```
