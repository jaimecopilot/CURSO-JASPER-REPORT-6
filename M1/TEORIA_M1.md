...
**Validación técnica final:** este estado no se ha comprobado únicamente por inspección. Los checkpoints 1.1-1.6 se ejecutaron end-to-end en GitHub Actions con **Temurin JDK 8** y **JasperReports Library 6.20.0**. Los seis compilaron el Java y el JRXML, generaron el `.jasper`, llenaron el `JasperPrint` y exportaron un PDF real. La ejecución final fue **6/6 PASS** (run 35905889756).