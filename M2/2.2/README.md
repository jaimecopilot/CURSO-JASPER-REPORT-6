# M2 / 2.2 - Texto estático y campos de texto

Checkpoint acumulativo del **Curso Profesional de JasperReports 6.20.0 Community**.

## Punto de partida

- `2.2` continúa el estado completo del checkpoint anterior.
- Para `2.2` el alumno debe seguir la Parte A de `M2/PRACTICA_M2.md`.
